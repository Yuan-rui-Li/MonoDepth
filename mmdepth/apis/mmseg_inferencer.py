...
from mmdepth.structures import SegDataSample
from mmdepth.utils import ConfigType, SampleList, get_classes, get_palette
from mmdepth.visualization import SegLocalVisualizer
...
class MMSegInferencer(BaseInferencer):
    ...
    Args:
        model (str, optional): Path to the config file or the model name
            defined in metafile. Take the `mmdepth metafile <https://github.com/open-mmlab/mmsegmentation/blob/main/configs/fcn/metafile.yaml>`_
        ...
        palette (list, optional): Input palette for result rendering, which is
            ...
            Defaults to None.
        dataset_name (str, optional): `Dataset name or alias <https://github.com/open-mmlab/mmsegmentation/blob/main/mmdepth/utils/class_names.py#L302-L317>`_
            visulizer will use the meta information of the dataset i.e. classes
            and palette, but the `classes` and `palette` have higher priority.
            Defaults to None.
        device (str, optional): Device to run inference. If None, the available
            device will be automatically used. Defaults to None.
        scope (str, optional): The scope of the model. Defaults to 'mmdepth'.
    """ # noqa
